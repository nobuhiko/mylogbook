...
class Model_Post extends \Orm\Model
{
	...
	public static function validate($factory)
	{
		...
		$val->add_field('depth_of_water_max', 'Depth Of Water Max', 'max_length[255]');
		...
		$val->add_field('air_temp', 'Air Temp', 'max_length[255]');
		...
		$val->add_field('weight', 'Weight', 'valid_string[numeric]');
